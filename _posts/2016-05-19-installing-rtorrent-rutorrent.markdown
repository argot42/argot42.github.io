...
Create the next file but be careful this configuration is not secured with password so everybody with access to your port 80 will be able to mess around with rtorrent. If the port is not facing it shouldn't be a big problem but it'll be better if you use it just for testing and eventually update your configuration to match the one in the part 2.2.
...
[xmlrpc-c-repo]: https://github.com/rakshasa/rtorrent/wiki
[libtorrent-repo]: https://github.com/rakshasa/rtorrent/wiki
